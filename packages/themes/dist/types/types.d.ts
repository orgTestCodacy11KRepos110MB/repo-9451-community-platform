declare const ProfileType: {
    readonly MEMBER: "member";
    readonly SPACE: "space";
    readonly WORKSPACE: "workspace";
    readonly MACHINE_BUILDER: "machine-builder";
    readonly COMMUNITY_BUILDER: "community-builder";
    readonly COLLECTION_POINT: "collection-point";
};
declare type ProfileTypeLabel = typeof ProfileType[keyof typeof ProfileType];
interface LinkList {
    label: string;
    url: string;
}
