...
const VarelaRound_Regular_woff_1 = __importDefault(require("./VarelaRound-Regular.woff"));
const VarelaRound_Regular_ttf_1 = __importDefault(require("./VarelaRound-Regular.ttf"));
const Inter_Regular_woff2_1 = __importDefault(require("./Inter-Regular.woff2"));
const Inter_Regular_woff_1 = __importDefault(require("./Inter-Regular.woff"));
const Inter_Regular_ttf_1 = __importDefault(require("./Inter-Regular.ttf"));
const Inter_Medium_woff2_1 = __importDefault(require("./Inter-Medium.woff2"));
const Inter_Medium_woff_1 = __importDefault(require("./Inter-Medium.woff"));
const Inter_Medium_ttf_1 = __importDefault(require("./Inter-Medium.ttf"));
